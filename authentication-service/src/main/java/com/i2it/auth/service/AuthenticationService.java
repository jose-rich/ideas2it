...
import com.i2it.auth.config.JwtService;
...
import com.i2it.auth.repository.TokenRepository;
import com.i2it.auth.token.TokenType;
...
public class AuthenticationService {
  ...
  private void revokeAllUserTokens(User user) {
    var validUserTokens = tokenRepository.findAllByUserName(user.getUsername());
